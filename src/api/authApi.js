...
// ---------------------------------------------------------
async function remoteLogin({ loginId, password, role }) {
...
export async function loginMarket({ loginId, password }) {
  ...
  const data = await remoteLogin({ loginId, password, role: 'MARKET' });
  return data;
}

// ---------------------------------------------------------
// 로그인 - 복지시설(센터)용 - completed
// ---------------------------------------------------------
export async function loginCenter({ loginId, password }) {
  ...
  // 실제 서버 모드
  const data = await remoteLogin({ loginId, password, role: 'CENTER' });
  return data;
}
